...
* Automatic work start and end detection
* Manual break and absence tracking
* Automatic office/home office detection based on the local network
* Configurable office quota period and threshold
...
* Cross-platform development (macOS) with Windows production support
...
* Automatische Erfassung von Arbeitsbeginn und Feierabend
* Manuelle Erfassung von Pausen und Abwesenheiten
* Automatische Erkennung von Büro und Homeoffice über das lokale Netzwerk
* Einstellbarer Zeitraum und Schwellenwert für die Officequote
...
* Plattformübergreifende Entwicklung (macOS) mit produktivem Einsatz unter Windows


## How to use

Installation, Windows-Exe, Bedienung, Einstellungen und Tests stehen in [HOW_TO_USE.md](HOW_TO_USE.md).
